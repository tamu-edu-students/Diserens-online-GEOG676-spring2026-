...
class Toolbox:
    def __init__(self):
        ...
        self.alias = "Graduated Colors Renderer"
...
class GraduatedColorsRenderer(object):
    def __init__(self):
        ...
        self.description = "Creates a graduated color map based on a specific attribute of a layer"
            ...
            if layer.isFeatureLayer:
                ...
                if hasattr(symbology, 'renderer'):
                    if layer.name == parameters[1].valueAsText:
                        ...
                        symbology.renderer.breakCound = 5
